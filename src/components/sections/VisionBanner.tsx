...
export default function VisionBanner() {
  return (
    <section className="relative w-full mx-auto py-[clamp(3rem,5vw,4.5rem)] overflow-hidden">
      ...
      {/* 2. CONTENT */}
      <div className="fluid-section relative z-10 w-full flex justify-center items-center text-center md:items-start md:text-left">
